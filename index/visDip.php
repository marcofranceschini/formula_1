	...
	<body style="background-color:#d7dee1">
		<?php
			...
			$rs=mysql_query("select * 
							from Dipendente
							where scuderia=\"".$riga['scuderia']."\" and specializzazione!='NULL'
							order by cognome DESC;", $connessione);
			echo "<h1 align=\"center\" >Dipendenti della ".$riga['scuderia']."</h1><div align=center>";
			echo "<table border=0 cellpadding=\"5\" cellspacing=\"15\">";
				...
				<td align=\"center\"><b>Nazionalita'</b></td><td align=\"center\"><b>Indirizzo</b></td><td align=\"center\"><b>Data di assunzione</b></td><td align=\"center\"><b>Specializzazione</b></td><td align=\"center\"><b>Reparto</b></td>";
				while($riga=mysql_fetch_array($rs)) {
					...
					echo "<td align=center>".$riga['specializzazione']."</td>";
