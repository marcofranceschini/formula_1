	...
	<body style="background-color:#d7dee1">
		<?php
			...
			$rs=mysql_query("select * 
							from Dipendente as d join Pilota on username=dipendente
							where d.scuderia=\"".$riga['scuderia']."\"
							order by cognome DESC;", $connessione);
			echo "<h1 align=\"center\" >Piloti della ".$riga['scuderia']."</h1><div align=center>";
			echo "<table border=0 cellpadding=\"5\" cellspacing=\"15\">";
				...
				<td align=\"center\"><b>Nazionalita'</b></td><td align=\"center\"><b>Indirizzo</b></td><td align=\"center\"><b>Data di assunzione</b></td><td align=\"center\"><b>Anni carriera</b></td><td align=\"center\"><b>Stipendio sponsor</b></td>";
				while($riga=mysql_fetch_array($rs)) {
					...
					echo "<td align=center>".$riga['anni_carriera']."</td>";
					echo "<td align=center>".$riga['stipendio_sponsor']."</td>";
					$immagine="Immagini/".$riga['cognome'].".jpg";
					echo "<td align=right><img src=\"".$immagine."\" width=\"200\" height=\"180\"/></td></tr>";
				}
			echo "</div>";
		?>
	</body>
